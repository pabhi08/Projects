...
class Calculator2
{
    ...
    {
         MarvellousCalculator mobj =new MarvellousCalculator(500,500,"Marvellous");
    }
}
...

{
    ...
    public void windowClosing(WindowEvent obj)    //Event  handler for the frame
    {
        System.exit(0);
    }
    public void actionPerformed(ActionEvent aobj)   //Event handler for buttons
    {
        ...
        if (aobj.getSource()==b1)   //Add
         ...
         else if(aobj.getSource()==b5)    // Percentage of two numbers
         {
            lobj.setText("Percent is :"+(No1*No2/100));
         }
